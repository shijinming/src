...
#ifndef UAV_ROUTING_PROTOCOL_H
#define UAV_ROUTING_PROTOCOL_H

#include "uav-rtable.h"
#include "uav-packet-queue.h"
...
public:
  ...
  static const uint32_t UAV_PORT;
...
private:
  ...
  // Receive UAV routing control packets
  /**
   * Receive and process UAV routing control packet
   * \param socket the socket for receiving UAV routing control packets
   */
  void
  RecvUAV (Ptr<Socket> socket);
  /// Send packet
  void
